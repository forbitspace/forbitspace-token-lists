...
const { ChainId } = require("@forbitspace/sdk");
...
(async () => {
  try {
    ...
    for (const key of Object.keys(ChainId)) {
      ...
      // Grab file file names of the forbitspace/icons repo at the token path
      ...
      for (const token of tokens) {
        ...
        if (!token.logoURI.includes("forbitspace/icons")) {
          // TODO: Automate this part...
          const logoURI = `https://raw.githubusercontent.com/forbitspace/icons/main/token/${icon}.jpg`;
